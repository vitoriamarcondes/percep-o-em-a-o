...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Estratégia de marca, direção criativa e comunicação para marcas que precisam ser mais claras, desejáveis e memoráveis." },
...
function Home() {
  ...
  const visible = projects.filter(
    (p) => filter === "Todos" || p.filters.includes(filter),
  );
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 pt-10 md:pt-16 pb-20">
          <div className="flex items-center gap-3 mb-10">
            ...
            <span className="eyebrow text-ink/70">Issue Nº 01 · Perception Report</span>
            <span className="hidden md:block flex-1 h-px bg-ink/15" />
            <span className="hidden md:block eyebrow text-ink/50">Brand Intelligence · São Paulo</span>
          </div>

          <div className="grid lg:grid-cols-12 gap-10 items-end">
            <div className="lg:col-span-7">
              <h1 className="font-display text-[clamp(3rem,9vw,8.5rem)] leading-[0.88] tracking-[-0.03em]">
                Transformo<br />
                <span className="italic font-light">percepção</span> em<br />
                <span className="lime-underline">presença</span>.
              </h1>
              <p className="mt-10 max-w-xl text-lg md:text-xl text-ink/75 leading-relaxed">
                Estratégia de marca, direção criativa e comunicação para
                projetos que precisam ser mais claros, desejáveis e memoráveis.
              </p>
              ...
              <div className="mt-10 flex flex-wrap gap-3">
                <Link to="/projetos" className="btn-ink">Explorar projetos →</Link>
                <Link to="/processo" className="btn-ghost">Conhecer meu processo</Link>
              </div>
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-16">
        <div className="flex items-end justify-between flex-wrap gap-4 mb-8">
          ...
          <p className="text-sm text-ink/60 max-w-xs">Cada projeto é apresentado pelo que transformou — não pela marca, mas pela percepção.</p>
        </div>
        ...
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 py-24 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <h2 className="font-display text-4xl md:text-6xl leading-[1] max-w-2xl">
              Sua marca pode ser boa. Mas ela está sendo <span className="italic">percebida</span> do jeito certo?
            </h2>
            <div className="mt-10 max-w-xl text-ink/75 space-y-4 text-base leading-relaxed">
              ...
              <p>Às vezes falta clareza. Às vezes falta desejo. Às vezes falta consistência. Às vezes falta uma linguagem que organize tudo.</p>
              <p>Eu trabalho nesse espaço: entre o que a marca é, o que ela quer vender e o que as pessoas precisam perceber para se aproximar.</p>
            </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="edito-card aspect-[4/5]">
              <img src={mood1} alt="Strategist moodboard" loading="lazy" className="w-full h-full object-cover" />
            </div>
            <span className="absolute -top-3 left-6 bg-background border border-ink/20 rounded-full px-3 py-1 eyebrow text-[10px]">visual code</span>
            <span className="absolute -bottom-3 right-6 bg-editorial text-background rounded-full px-3 py-1 eyebrow text-[10px]">brand feeling</span>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-24">
        ...
        <p className="mt-8 max-w-2xl text-ink/75 leading-relaxed">
          Meu trabalho conecta estratégia comercial, direção criativa, comportamento e narrativa para transformar marcas, campanhas e experiências em presenças mais reconhecíveis. Ajudo projetos a saírem do genérico e ocuparem um lugar mais claro na mente, no desejo e na vida das pessoas.
        </p>

        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-14">
          {[
            { n: "i", t: "Clareza", d: "Para marcas que precisam comunicar melhor o próprio valor." },
            { n: "ii", t: "Desejo", d: "Para produtos, serviços e ideias que precisam ganhar imaginário." },
            { n: "iii", t: "Consistência", d: "Para comunicações que ainda parecem fragmentadas." },
            { n: "iv", t: "Presença", d: "Para marcas que querem ser lembradas pelo que significam." },
          ].map((c) => (
            <div key={c.t} className="edito-card p-7 group hover:bg-ink hover:text-background transition-colors duration-500">
              <div className="flex items-center justify-between mb-12">
                <span className="eyebrow text-editorial group-hover:text-lime">{c.n}</span>
                <span className="text-lime opacity-0 group-hover:opacity-100 transition-opacity">✦</span>
              </div>
      ...
      <section className="bg-ink text-background">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 py-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-background/10 mt-14 rounded-3xl overflow-hidden">
            {[
              { n: "7+", l: "anos", d: "atuando entre comunicação, campanhas, conteúdo, direção visual e estratégia." },
              { n: "3×", l: "mais carteira atendida", d: "em experiência comercial com relacionamento, capacitação e adaptação de linguagem." },
              { n: "400+", l: "pessoas", d: "em experiência criada e produzida com ingressos esgotados." },
              { n: "03", l: "reconhecimentos", d: "por impacto, crescimento e conexão em projeto de comunicação." },
              { n: "08", l: "setores", d: "moda, lifestyle, previdência, setor público, comercial, institucional, social e marcas com propósito." },
              { n: "∞", l: "leituras", d: "atravessar mercados diferentes me ensinou a ler pessoas antes de criar para marcas." },
            ].map((s, i) => (
              <div key={i} className="bg-ink p-8 md:p-10">
                <div className="font-display text-6xl md:text-7xl text-lime leading-none">{s.n}</div>
      ...
      <section className="bg-mist/40">
        <div className="mx-auto max-w-4xl px-6 md:px-10 py-32 text-center">
          ...
          <div className="mt-10">
            <Link to="/metodo" className="btn-ink">Ver método completo</Link>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-24">
        ...
        <h2 className="font-display text-4xl md:text-5xl mt-3 max-w-2xl">Perguntas que organizam meu raciocínio.</h2>
        ...
        <div className="edito-card relative overflow-hidden bg-ink text-background p-12 md:p-20">
          ...
          <div className="relative max-w-3xl">
            ...
            <h2 className="font-display text-4xl md:text-6xl mt-4 leading-[1]">
              Se a sua marca precisa de mais do que aparência,<br />
              talvez ela precise de <span className="italic">direção</span>.
            </h2>
            <p className="mt-8 text-background/80 max-w-xl">Vamos construir uma presença mais clara, sensível e estrategicamente desejável.</p>
            <div className="mt-10 flex flex-wrap gap-3">
              <Link to="/contato" className="btn-ink bg-lime text-ink hover:bg-background">Iniciar conversa</Link>
              <Link to="/projetos" className="btn-ghost border-background text-background hover:bg-background hover:text-ink">Ver universos construídos</Link>
            </div>
          </div>
        </div>
      </section>
