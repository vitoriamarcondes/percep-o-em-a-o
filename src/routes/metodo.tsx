...
export const Route = createFileRoute("/metodo")({
  head: () =>
    buildSeo({
      title: "Método de estratégia de marca em 4 pilares · Vitória Marcondes",
      description:
        "Estratégia de negócio, essência, expressão e comunicação. Quatro pilares que constroem a jornada da marca e o vínculo com pessoas.",
      path: "/metodo",
      ogTitle: "4 pilares de marca — Método",
      ogDescription:
        "Quatro pilares que constroem a jornada da marca e o vínculo estratégico com pessoas.",
    }),
  component: Metodo,
});
...
const builds = [
  {
    ...
    d: "Posicionamento, público, território, diferenciação, narrativa e valor percebido.",
  },
  {
    t: "Direção criativa",
    d: "Conceito, campanha, moodboard, estética, produção visual e atmosfera.",
  },
  {
    t: "Branding emocional",
    d: "Manifesto, tom de voz, universo simbólico, personalidade e vínculo.",
  },
  {
    t: "Comunicação estratégica",
    d: "Conteúdo, linha editorial, eventos, ativações, relacionamento e presença digital.",
  },
  {
    t: "Moodboards estratégicos",
    d: "Pesquisa visual, códigos estéticos, referências, paleta, linguagem e direção de percepção.",
  },
];
    ...
    <div>
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 pt-16 md:pt-24 pb-12">
        ...
        <p className="mt-8 max-w-xl text-ink/75 text-lg leading-relaxed">
          Em cada projeto, esses quatro pilares constroem a{" "}
          <span className="lime-underline">jornada da marca</span> e estruturam a interação com os
          clientes — criando vínculo estratégico entre marca e pessoas.
        </p>
      </section>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-6 md:gap-12">
                  <span
                    className={`font-display text-5xl md:text-7xl leading-none ${isOpen ? "text-lime" : "text-editorial"}`}
                  >
                    {s.n}
                  </span>
                  <div className="flex-1">
                    ...
                    <p
                      className={`mt-3 text-base md:text-lg ${isOpen ? "text-background/80" : "text-ink/75"}`}
                    >
                      {s.body}
                    </p>
                    {isOpen && (
      ...
      <section className="bg-paper/50">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 py-24">
          ...
          <p className="mt-6 max-w-xl text-ink/70">
            Às vezes a marca precisa de clareza. Às vezes de linguagem. Às vezes de campanha. Às
            vezes de uma nova forma de ser percebida.
          </p>
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-24 text-center">
        <p className="font-display text-3xl md:text-5xl italic max-w-3xl mx-auto">
          "Marca forte não é a que aparece mais. É a que cria{" "}
          <span className="lime-underline not-italic">vínculo</span> com pessoas de maneira
          estratégica."
        </p>
